...
static void USART_Config(void)
{
	...
	*/
    ...
    GPIO_InitStructure.GPIO_OType = GPIO_OType_PP; //推挽复用输出
    GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_UP; //上拉
    GPIO_Init(GPIOC,&GPIO_InitStructure); //初始化GPIOC12与GPIOD2

    GPIO_InitStructure.GPIO_Pin =  GPIO_Pin_2; //GPIOC12与GPIOD2
    GPIO_Init(GPIOD,&GPIO_InitStructure); //初始化GPIOC12与GPIOD2
	...
	*/
    ...
    GPIO_InitStructure.GPIO_OType = GPIO_OType_PP; //推挽复用输出
    GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_UP; //上拉
    GPIO_Init(GPIOC,&GPIO_InitStructure); //初始化GPIOG14与GPIOG9
